      ...
      <div class="nk-header-news d-none d-xl-block">
        <div class="nk-news-list"><a class="nk-news-item" href="#">
            ...
            <div class="nk-news-text">
              <p><span> {{ config('app.name')}}</span></p><em class="icon ni ni-external"></em>
            </div>
          </a></div>
      </div>
            ...
            <div class="dropdown-menu dropdown-menu-xl dropdown-menu-end dropdown-menu-s1">
              ...
              <div class="dropdown-body">
                <div class="nk-notification">
                  ...
                  <!-- Notification 1 -->
                  <div class="nk-notification-item dropdown-inner unread">
                  ...
                  <div class="nk-notification-item dropdown-inner unread">
                    <div class="nk-notification-icon">
                      <em class="icon icon-circle bg-danger-dim ni ni-alert-circle"></em>
                    </div>
                    <div class="nk-notification-content">
                      <div class="nk-notification-text">
                  ...
                  <div class="nk-notification-item dropdown-inner">
                    <div class="nk-notification-icon">
                      <em class="icon icon-circle bg-info-dim ni ni-bell"></em>
                    </div>
                    <div class="nk-notification-content">
                      <div class="nk-notification-text">
