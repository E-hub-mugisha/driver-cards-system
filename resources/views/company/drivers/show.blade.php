...
<div class="modal fade" id="editDriverModal{{ $driver->id }}">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form method="POST" action="{{ route('company.drivers.update',$driver->id) }}" enctype="multipart/form-data"> @csrf @method('PUT') <div class="modal-header">
                ...
                <div class="modal-footer"> <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button> <button type="submit" class="btn btn-success">Update</button> </div>
            </form>
        </div>
    </div>
</div> 
...
<div class="modal fade" id="addBehaviorModal-{{ $driver->id }}">
    <div class="modal-dialog">
        <form method="POST" action="{{ route('company.drivers.behaviors.store', $driver) }}" class="modal-content"> @csrf <input type="hidden" name="driver_id" value="{{ $driver->id }}">
            <div class="modal-header">
